...
public class AuthController {
    ...
    @ApiErrorExceptions({ErrorCode.INVALID_INPUT, ErrorCode.DUPLICATE_USER, ErrorCode.DUPLICATE_EMAIL, ErrorCode.TERMS_NOT_AGREED, ErrorCode.CHARACTER_NOT_FOUND})
    @PostMapping("/signup")
